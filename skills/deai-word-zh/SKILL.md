---
name: deai-word-zh
description: 将带“机器味”或“翻译腔”的中文文本重写为严谨自然的人类学术表达（国内顶刊标准），替换空泛渲染词、消除长定语与被动句、禁用 Markdown，输出适配 Word。Rewrites AI-flavored or translationese Chinese into natural formal Chinese academic writing for Word; strips empty rhetoric, long attributives and Markdown. Use when Chinese text reads machine-written.
---

# 去 AI 味（Word 中文）：中文文本去 AI 化重写
