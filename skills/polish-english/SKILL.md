---
name: polish-english
description: 深度润色英文 LaTeX 论文片段至顶会（NeurIPS/ICLR/ICML）零错误水准：语法、学术语体、句式、冠词、所有格规范全面修正，保留 LaTeX 命令与格式。Deep-polishes English LaTeX fragments to top-conference quality with zero errors: grammar, academic register, sentence structure, possessives. Use when the user wants an English paper paragraph polished.
---

# 表达润色（英文论文）：英文 LaTeX 深度润色
