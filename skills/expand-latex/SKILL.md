---
name: expand-latex
description: 通过显式化隐含结论、前提与因果关系，微幅扩写英文 LaTeX 片段（约 5-15 词），严禁注水或编造。Slightly expands English LaTeX by 5-15 words by making implicit logic explicit, with no padding or fabrication. Use when a paper fragment feels thin and needs more depth.
---
