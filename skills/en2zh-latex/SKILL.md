---
name: en2zh-latex
description: 将英文 LaTeX 片段直译为流畅中文，自动删除 \cite/\ref/\label 命令、剥离 \textbf 等格式、把数学公式转为自然语言。Translates English LaTeX snippets into plain readable Chinese for quick comprehension, stripping citation/format commands and converting math to plain text. Use when the user needs to understand an English paper paragraph.
---

# 英转中（LaTeX）：英文 LaTeX → 流畅中文
