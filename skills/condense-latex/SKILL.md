---
name: condense-latex
description: 在不损失信息的前提下微幅缩减英文 LaTeX 片段（约 5-15 词），通过句法压缩与剔除冗余词来压字数。Slightly condenses English LaTeX by 5-15 words via syntactic compression without losing any technical detail. Use when a paper fragment is over the length limit and needs minor trimming.
---
