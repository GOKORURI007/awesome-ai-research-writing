---
name: polish-chinese
description: 以克制原则润色中文学术段落（计算机学报/软件学报标准）：仅修复明显语病与逻辑漏洞，原文通顺则原样保留并给予肯定，输出纯文本适配 Word。Restrained polish of Chinese academic paragraphs for CS journals: only fixes obvious errors and logic gaps, keeps good text untouched, Word-friendly plain output. Use when the user wants a Chinese paper paragraph reviewed/polished.
---

# 表达润色（中文论文）：中文段落专业审视与润色
