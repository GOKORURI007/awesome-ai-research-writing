---
name: table-caption
description: 根据中文描述生成符合顶会规范的英文表标题：名词短语用 Title Case、完整句子用 Sentence case，推荐 Comparison with / Ablation study on / Results on 等标准表达，LaTeX 转义。Writes precise English table captions using standard academic phrases (Comparison with, Ablation study on, Results on) from a Chinese description. Use when the user needs an English caption for a table.
---
