---
name: zh2en-latex
description: 将中文草稿翻译并润色为英文学术 LaTeX 片段（ICML/ICLR 审稿人级），自动转义特殊字符、去 AI 味、统一时态。Translates and polishes Chinese paper drafts into reviewer-grade English academic LaTeX, with proper escaping and clean style. Use when the user pastes a Chinese draft and wants an English LaTeX paper fragment.
---

# 中转英（LaTeX）：中文草稿 → 英文学术 LaTeX
