---
name: logic-check
description: 对英文 LaTeX 终稿做“红线审查”：仅报告致命逻辑矛盾、术语不一致与严重语法错误，可改可不改的风格问题一律忽略；无问题则输出“检测通过”。Final consistency and logic check of an English LaTeX fragment: only flags fatal contradictions, terminology drift and serious grammar errors, ignoring style nits. Use before submission.
---

# 逻辑检查：英文 LaTeX 终稿红线审查
