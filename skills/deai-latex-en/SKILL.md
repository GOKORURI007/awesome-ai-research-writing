---
name: deai-latex-en
description: 将 AI 味浓重的英文 LaTeX 重写为自然、地道的人类学术表达（ACL/NeurIPS 标准）：移除机械连接词、列表格式、破折号与高滥用词汇（leverage/delve/tapestry 等），并附 AI 高频词替换清单。Rewrites AI-flavored English LaTeX into natural human academic writing; removes mechanical connectors, list formats, dashes and buzzwords, with a word-replacement list. Use when text reads like ChatGPT.
---

# 去 AI 味（LaTeX 英文）：英文 LaTeX 去 AI 化重写
