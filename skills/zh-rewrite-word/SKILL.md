---
name: zh-rewrite-word
description: 将碎片化、口语化的中文草稿重写为逻辑连贯、符合中文学术规范（《计算机学报》《软件学报》风格）的论文段落，输出纯净文本适配 Word。Rewrites fragmented/colloquial Chinese notes into coherent formal Chinese academic paragraphs for Word and Chinese journals. Use when the user has loose Chinese ideas and wants polished Chinese prose.
---

# 中转中（Word）：中文草稿 → 中文学术段落
